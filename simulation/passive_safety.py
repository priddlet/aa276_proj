"""Passive safety (Option 2): natural CW drift without further thrust.

A state is *passively safe* (for a finite horizon) if the coast trajectory with
``u = 0`` never enters the inner proximity KOZ. This is not an HJ BRT; it is a
cheap binary check on top of the collision BRT (Option 1).
"""
...
def is_passively_safe_natural_coast(
    ...
    *,
    ...
    """Inverse of :func:`natural_coast_hits_inner_koz`."""
